...
export class EnvSecretsService {
  ...
  getApiKey() {
    return process.env.OPENAI_API_KEY || 'sk-proj-1234567890abcdefghijklmnopqrstuvwxyz';
  }
  
  getDatabaseUrl() {
    return process.env.DATABASE_URL || 'postgresql://admin:supersecret123@localhost:5432/myapp';
  }
